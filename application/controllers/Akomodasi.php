...
class Akomodasi extends CI_Controller
{
    ...
    {
        parent::__construct();
        // $this->load->model('nama model', 'akomodasi');
    }
    ...
    public function cariAkomodasi()
    {
        //pagination config
        $config['base_url'] = 'http://localhost/pariwisata/akomodasi/cariakomodasi';
        $this->db->like('nama_akomodasi', $this->input->get('nama_akomodasi'));
        $config['total_rows'] = $this->db->get('akomodasi')->num_rows();
        $config['per_page'] = 6;
        ...
        $cari = $this->input->get('nama_akomodasi');
