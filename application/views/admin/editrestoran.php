...
<div class="container-fluid">
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            ...
            <input type="text" id="garis_bujur" value=" <?= $restoran['garis_bujur'] ?>" class="form-control" name="garis_bujur">
    ...
    <div class="row mt-4">
        <div class="col-md-12">
            ...
            <input type="text" id="garis_lintang" value=" <?= $restoran['garis_lintang'] ?>" class="form-control" name="garis_lintang">
...
<script>
    ...
    var map = new mapboxgl.Map({
        ...
        center: [<?= $restoran['garis_bujur'] ?>, <?= $restoran['garis_lintang'] ?>],
        zoom: 11
    });
    ...
    var marker = new mapboxgl.Marker({
        ...
        .setLngLat([<?= $restoran['garis_bujur'] ?>, <?= $restoran['garis_lintang'] ?>])
        .addTo(map);
