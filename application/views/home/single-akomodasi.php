...
<script>
    navigator.geolocation.getCurrentPosition(function(location) {
        ...
        var popup = L.popup()
            .setLatLng([<?= $akomodasi['garis_lintang'] ?>, <?= $akomodasi['garis_bujur'] ?>])
            .setContent('<a class="btn btn-outline-primary" href="https://www.google.com/maps/dir/?api=1&origin=' + location.coords.latitude + ',' + location.coords.longitude + '&destination=<?= $akomodasi['garis_lintang'] ?>, <?= $akomodasi['garis_bujur'] ?>">Navigasi</a>')
            .openOn(map);
